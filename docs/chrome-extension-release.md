...
5. Add screenshots, category, support contact, and a privacy policy URL/page.
   The draft policy is in
   [`docs/chrome-web-store-privacy-policy.md`](chrome-web-store-privacy-policy.md).
...
For the upload-time audit, dashboard copy, screenshot checklist, unlisted beta
steps, and post-approval clean-profile test, see
[`docs/chrome-web-store-launch-readiness.md`](chrome-web-store-launch-readiness.md).
