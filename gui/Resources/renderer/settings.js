...
// panel (Dither, Aurora, Glass), drives the live background instantly,
...
(function () {
  ...
  const PRESETS = [
    ...
    { name: "Aurora", s: { kind: "aurora", pixelColor: NAVY, backgroundColor: CREAM, speed: 0.1, zoom: 4.8, auroraIntensity: 0.55 } },
    { name: "Glass", s: { kind: "glass", pixelColor: NAVY, backgroundColor: CREAM, speed: 0.002, glassMode: "blur", glassPanes: 18, glassSoftness: 9, glassBrightness: 0.6, glassRefraction: 0.02 } },
  ];
  ...
  window.applyStarleeBackgroundSettings = function (s) {
    state = normalizedSettings(Object.assign({}, state, s || {}));
